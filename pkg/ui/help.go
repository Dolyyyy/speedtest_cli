...
func PrintHelp() {
	...
	fmt.Println("  speedtest --100g             # Benchmark unthrottled 100G Datacenter Backbones")
	fmt.Println("  speedtest --threads 64       # Maximize multi-stream for 10G/50G/100G link saturation")
	...
	fmt.Println("  speedtest -s 61933           # Target Scaleway 10G server")
	...
	fmt.Printf("  %-25s %s\n", ColorWarning("-B, --100g"), "Enable unthrottled 100G Datacenter Backbone benchmark mode")
	...
	fmt.Printf("  %-25s %s\n", ColorWarning("-t, --threads <N>"), "Number of parallel TCP connections for 10G/50G/100G links (default: 16)")
